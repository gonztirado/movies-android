...
data class MovieDetailsEntity(
    ...
    companion object {
        fun empty() = MovieDetailsEntity(
            ...
            String.empty(), String.empty(), 0, String.empty(), String.empty(), emptyList(), true, Error = String.empty()
        )
    }

    fun toMovieDetails() =
        MovieDetails(imdbID, Title, Poster, Plot, Actors, Director, Year, Runtime, Awards, Ratings.map { it.toMovieRating() })
}
